...
const { allCountries,abbreviation,africa,america,asia,oceania,capital,continent,countries,europe,sNo} = placeholders;
...
async function createSelectMap(jsonURL){
    ...
    optionsMap.set("all",allCountries);optionsMap.set("asia",asia);optionsMap.set("europe",europe);optionsMap.set("africa",africa);optionsMap.set("america",america);optionsMap.set("australia",oceania);
...
export default async function decorate(block) {
    ...
    console.log('block', block, countries)
